...
export const blockedCommitmentInspectorState = {
  ...
  documents: [
    ...
    },
    {
      ...
      owner: 'Legal ops',
      requirementLabel: 'Required',
      status: { kind: 'uploaded', label: 'Package sent' },
  ...
  documents: [
    {
      ...
      owner: 'Legal ops',
      requirementLabel: 'Required',
      status: { kind: 'approved', label: 'Complete' },
  ...
  documents: [
    {
      ...
      owner: 'Fund admin',
      requirementLabel: 'Required',
      status: { kind: 'under_review', label: 'Needs review' },
  ...
  documents: [
    {
      ...
      owner: 'Legal ops',
      requirementLabel: 'Required',
      status: { kind: 'under_review', label: 'Pending review' },
      visibilityLabel: 'Investor evidence',
    },
  ],
  investor: {
  ...
  documents: [
    {
      ...
      status: { kind: 'under_review', label: 'Needs operator review' },
